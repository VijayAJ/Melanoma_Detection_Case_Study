# Melanoma Detection Case Study - CNN
...
- The training loss is low when compare with the validation loss.However the loss difference is okay. This is sign of good fit.
